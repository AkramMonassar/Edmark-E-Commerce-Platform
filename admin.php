...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'confirm_order') {
        ...
        if ($name === '' || $price <= 0) {
            $flash = 'أدخل اسم المنتج وسعرًا صحيحًا'; $tab = 'products';
        } else {
            $img = 'photo/1.png';
            ...
            $flash .= "تمت إضافة المنتج ✅"; $tab = 'products';
        }
...
<div class="container my-4">
  ...
  <?php if ($tab === 'stats'): ?>
  <div class="row g-3">
    <div class="col-6 col-lg" data-aos="fade-up"><div class="card border-0 shadow-sm text-center p-3"><i class="bi bi-people fs-3 text-brand"></i><h4 class="mt-2 mb-0"><?php echo $sUsers; ?></h4><small class="text-muted">مستخدم</small></div></div>
    <div class="col-6 col-lg" data-aos="fade-up" data-aos-delay="100"><div class="card border-0 shadow-sm text-center p-3"><i class="bi bi-box-seam fs-3 text-brand"></i><h4 class="mt-2 mb-0"><?php echo $sProducts; ?></h4><small class="text-muted">منتج</small></div></div>
    <div class="col-6 col-lg" data-aos="fade-up" data-aos-delay="200"><div class="card border-0 shadow-sm text-center p-3"><i class="bi bi-bag fs-3 text-brand"></i><h4 class="mt-2 mb-0"><?php echo $sOrders; ?></h4><small class="text-muted">طلب</small></div></div>
    <div class="col-6 col-lg" data-aos="fade-up" data-aos-delay="300"><div class="card border-0 shadow-sm text-center p-3"><i class="bi bi-hourglass-split fs-3 text-warning"></i><h4 class="mt-2 mb-0"><?php echo $sPending; ?></h4><small class="text-muted">بانتظار الإجراء</small></div></div>
    <div class="col-6 col-lg" data-aos="fade-up" data-aos-delay="400"><div class="card border-0 shadow-sm text-center p-3"><i class="bi bi-cash-coin fs-3 text-success"></i><h4 class="mt-2 mb-0"><?php echo $sRevenue; ?>$</h4><small class="text-muted">الإيرادات المؤكدة</small></div></div>
  </div>
  <?php endif; ?>
  ...
  <div class="table-responsive bg-white rounded-3 shadow-sm p-3" data-aos="fade-up">
    <table class="table align-middle small">
      <thead class="table-light"><tr><th>#</th><th>العميل</th><th>الإجمالي</th><th>الطريقة</th><th>التفاصيل</th><th>الحالة</th><th>التاريخ</th><th></th></tr></thead>
      <tbody>
  ...
  <div class="table-responsive bg-white rounded-3 shadow-sm p-3" data-aos="fade-up">
    <table class="table align-middle small">
      <thead class="table-light"><tr><th>صورة</th><th>الاسم</th><th>السعر</th><th>الكمية</th><th>الوصف</th><th></th></tr></thead>
      <tbody>
  ...
  <div class="table-responsive bg-white rounded-3 shadow-sm p-3" data-aos="fade-up">
    <table class="table align-middle small">
      <thead class="table-light"><tr><th>#</th><th>الاسم</th><th>الإيميل</th><th>الصلاحية</th><th></th></tr></thead>
      <tbody>
